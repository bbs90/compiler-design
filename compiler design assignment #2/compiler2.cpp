...
void list::stable()
{
	...
	{
		op<<j->word<<endl<<"IDENTIFER"<<endl<<endl;
	}
}
...
void part2(int a[][14])
{
	...
	op<<"LIST OF ALL LEXEMS PRESENT IN INPUT CODE"<<endl;
	op<<endl;
	lex_state=1;
	while(!ip2.eof())                    
	{								
		...
		for(cp=0;lin[cp]!='\0';cp++)
		{
			...
			switch(lex_state)
			{
				...
				case 3:
				{
					...
					if(j)
					{
						op<<tok<<endl<<"KEYWORD"<<endl<<endl;
					}
					else
					{
						op<<tok<<endl<<"IDENTIFIER"<<endl<<endl;
					}
					store[0]='\0';
					lex_state=1;
				}
				...
				case 13:
				{
					...
					op<<tok<<endl<<"ASSIGNMENT OPERATOR"<<endl;
					op<<endl;
					store[0]='\0';
					lex_state=1;
				}
				...
				case 15:
				{
					...
					op<<tok<<endl<<"LESS THAN OR EQUAL TO"<<endl;
					op<<endl;
					store[0]='\0';
					lex_state=1;
				}
				...
				case 16:
				{
					...
					op<<tok<<endl<<"NOT EQUAL TO"<<endl<<endl;
					store[0]='\0';
					lex_state=1;
				}
				break;
				...
				case 18:
				{
					...
					op<<tok<<endl<<"GREATER THAN OR EQUAL TO"<<endl;
					op<<endl;
					store[0]='\0';
					lex_state=1;
				}
 ...
 */ 		
		if((lex_state==2))
		{
			...
			if(j)
			{
				op<<tok<<endl<<"KEYWORD"<<endl;
				op<<endl;
			}
			else
			{
				op<<tok<<endl<<"IDENTIFIER"<<endl;
				op<<endl;
			}
			store[0]='\0';
			lex_state=1;
